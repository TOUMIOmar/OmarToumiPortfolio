    ...
    <div className="flex flex-col md:flex-row gap-4">
      <div className="flex flex-col w-full md:w-[60%] gap-1">
        <motion.h2
          ...
          className="text-[36px] text-[#FFFFFF] text-center md:text-left md:text-[64px] font-bold"
        >
        ...
        <div className="flex gap-4 justify-center md:justify-normal">
          {isSentence2Visible ? (
            ...
            >
              <Link href="https://github.com/TOUMIOmar" target="_blank">
                <Image
                  src="/github.png"
                  width={100}
                  height={100}
          ...
          {isSentence3Visible ? (
            ...
            >
              <Link
                href="https://www.linkedin.com/in/toumiomar/"
                target="_blank"
              >
                <Image
                  src="/linkedin.png"
